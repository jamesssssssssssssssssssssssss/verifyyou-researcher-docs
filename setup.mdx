...
<a className="vy-next" href="/qualtrics-setup"><span className="vy-next-step">3 of 6</span><span className="vy-next-label">Next: Qualtrics setup</span><span className="vy-next-arrow"><Icon icon="arrow-right" iconType="light" size={14} /></span></a>
