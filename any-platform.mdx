...
description: "One check, one single-use credential, enforced by whatever gate your platform already has. Alchemer and Qualtrics today; the pattern fits anywhere."
icon: "layer-group"
---

<a className="vy-next" href="/setup"><span className="vy-next-step">6 of 6</span><span className="vy-next-label">Next: Ready? Start the setup</span><span className="vy-next-arrow"><Icon icon="arrow-right" iconType="light" size={14} /></span></a>
...
| **Qualtrics** | A one-time code on the link | The Authenticator in Survey Flow: each code authenticates exactly once |
