  ...
  <Step title="The fork: pass or fail">
    ...
    <div className="vy-fork">
      ...
      <div className="vy-fork-row">
        <span className="vy-fork-pill vy-fork-pass"><span className="vy-fork-ic"><Icon icon="circle-check" iconType="light" size={15} /></span>Pass: into your survey</span>
        <span className="vy-fork-pill vy-fork-fail"><span className="vy-fork-ic"><Icon icon="circle-xmark" iconType="light" size={15} /></span>Fail: screened out</span>
      </div>
    </div>
    ...
    <Frame caption="After a pass: your Alchemer login page, password already in the box. With auto-submit on, they skip this page entirely. Illustration; the real page inherits your survey theme.">
