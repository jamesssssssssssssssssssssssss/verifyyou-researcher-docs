...
description: "One screen at a time: the click, the scan, the pass, and the gate opening into your study."
icon: "mobile-screen"
---

<a className="vy-next" href="/any-platform"><span className="vy-next-step">5 of 6</span><span className="vy-next-label">Next: The same mechanism, any platform</span><span className="vy-next-arrow"><Icon icon="arrow-right" iconType="light" size={14} /></span></a>
